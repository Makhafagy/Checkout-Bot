...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("TrackSter")
        ...
        self.logo.setText("")
        self.logo.setPixmap(QtGui.QPixmap("images/checkoutbot.PNG"))
        ...
        self.createdialog.setWindowIcon(QtGui.QIcon("images/checkoutbot.PNG"))
